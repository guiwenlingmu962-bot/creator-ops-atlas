...
const translations = {
  en: {
    ...
    serviceOneTitle: "Inbox & inquiry triage", serviceOneCopy: "Classify support requests, flag urgent cases, and draft neutral replies. A person approves every message.", serviceOnePrice: "US$199 / ¥30,000",
    serviceTwoTitle: "Catalog & CSV cleanup", serviceTwoCopy: "Normalize titles, tags, dates, and product metadata without copying protected media or storing account credentials.", serviceTwoPrice: "US$199 / ¥30,000",
    ...
    consultButton: "Hire securely on Freelancer", consultPublic: "Request a public fit check", consultAudit: "Open the 15-minute audit", consultNote: "Use synthetic examples only. Payment and private messages stay on Freelancer.",
  ...
  ja: {
    ...
    serviceOneTitle: "問い合わせ整理", serviceOneCopy: "問い合わせ分類、緊急案件の検出、中立的な返信下書きを作成。送信は人間が承認します。", serviceOnePrice: "US$199 / 30,000円",
    serviceTwoTitle: "カタログ・CSV整理", serviceTwoCopy: "保護対象メディアを複製せず、認証情報も保存せずに、商品名・タグ・日付・メタデータを整形。", serviceTwoPrice: "US$199 / 30,000円",
    ...
    consultButton: "Freelancerで安全に依頼", consultPublic: "公開の適合診断を依頼", consultAudit: "15分診断を開く", consultNote: "架空サンプルのみ使用してください。支払いと非公開連絡はFreelancer上で行います。",
